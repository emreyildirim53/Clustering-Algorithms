...
public class CCPoint {
     ...
     *        y-coordinate for the location of the point.
     */
    public CCPoint(double x, double y,float size) {
        this(x, y, Color.black, new BasicStroke(size));
    }
    public CCPoint(double x, double y,Color color,float size) {
        this(x, y, color, new BasicStroke(size));
    }
